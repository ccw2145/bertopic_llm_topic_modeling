# LLM-Enhanced Topic Modeling with BERTopic
Example notebooks for Topic Modeling using BERTopic Zero-Shot and LLMs. 

## Notebooks
- Data Preprocessing with LLM Function Calling: [01_SETUP_DATA_function_calling](https://github.com/ccw2145/bertopic_llm_topic_modeling/blob/main/01_SETUP_DATA_function_calling.py)
- Topic Modeling with BERTopic and LLM: [02_TOPIC_MODELING_bertopic](https://github.com/ccw2145/bertopic_llm_topic_modeling/blob/main/02_TOPIC_MODELING_bertopic.py)
